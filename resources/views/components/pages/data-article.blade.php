    ...
    <div class="position-relative mb-3">
        ...
        <div class="bg-white border border-top-0 p-4">
            ...
            <div style="height: 100px;">
                <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold article-text-name" 
                    style="display: -webkit-box !important;" href="{{ route('public.article', $dataArticle->id) }}">
                    {{ $dataArticle->name }}
                </a>
            </div>
        </div>
